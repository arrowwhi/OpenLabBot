...
insert into question_groups (group_name, group_preview)
values ('ВОПРОС-БОНУС', 'На десерт же у нас - самое удивительное, что можно представить в мире химии. Бесспорно, химия воплощает в себе бескрайний мир невероятных реакций и элементов, но иногда самые неожиданные соединения дают самый неожиданный эффект, не так ли?');
